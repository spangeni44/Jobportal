...
if(isset($_GET['search']) && !empty($_GET['search'])){
    $totalres=count($job_post->getSpecificJobPosts());
}
...
?>
            ...
            <!-- <div class='col'></div> -->
                ...
                <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 " style="padding-top: 5px;">
                    <div>
                        <div class="row padding-0">
                            <div class="col-md-12 col-lg-12 col-sm-12 col-xl-12 " style='padding-right:10px;'>
                                <center><?php  flash(); ?></center>
                                <?php require_once 'inc/search_box.php'; ?>
                            </div>
