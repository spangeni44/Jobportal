...
abstract class Database{
    ...
    // Test
    final protected function selectInDesc($args=array(),$is_die=false){
        try{
            $this->sql = "SELECT ";
            ...
            if(isset($args['limit']) && !empty($args['limit'])){
                if(is_array($args['limit'])){
					$this->sql .= " limit ".$args['limit']['start'].", ".$args['limit']['perpage'];
				}
            }
			if($is_die){
				debug($args);
            ...
            if(isset($args['order_by'])){
                $this->stmt->bindValue(":".$args['order_by']);
            }

            if(isset($args['limit'])){
                foreach($args['limit'] as $column_name=>$value){
                $this->stmt->bindValue(":".$value);
                }
            }
